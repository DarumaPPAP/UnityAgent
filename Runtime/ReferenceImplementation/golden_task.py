...
def _snapshot(project_root: Path) -> dict[str, Any]:
    return {
        ...
        "unity_artist_cli": {"available": True, "version": "0.0.1-beta", "executable_path": "C:/Tools/unity-artist.exe", "project_bound": True, "package_installed": True, "package_version": "0.0.1-beta", "pipeline_reachable": True, "unity_version": "6000.6.0f1", "render_pipeline": "builtin", "support_tier": "primary", "compatibility_backend": "builtin_editor_api", "capabilities": ["visual_art.refine", "visual_art.capture"], "failure_class": None, "binding_status": "bound", "bound_instance_id": "unity-artist-reference"},
